...
For example, pareto.jl is setup to run 400,000 walkers (200,000 for each of the two values of $\alpha$ to be used), so the script should be run 400,000 times, each time with a different argument, which must takes its values between 1 and 400,000.
